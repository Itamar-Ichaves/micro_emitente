...
class GetSpecificNaturezaOpController extends Controller
{
    ...
    {
        $this->natOpService->getNaturezaOpSpecific($request->token_company, $request->emitente_uuid, $request->uuid);
    }
}
